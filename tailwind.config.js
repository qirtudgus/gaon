...
module.exports = {
  ...
  plugins: [
    ...
    plugin(({ addUtilities }) => {
      addUtilities({
        ".label": {
          "@apply block text-left text-12 text-gray-700 mb-2": "",
        },
        ".button-primary": {
          "@apply rounded-full border border-transparent bg-key-2 disabled:bg-gray-1-disabled text-white":
            "",
        },
        ".button-secondary": {
          "@apply rounded-full bg-white border border-key-2 disabled:border-gray-1-disabled disabled:text-gray-1-disabled text-key-2":
            "",
        },
        ".text-title": {
